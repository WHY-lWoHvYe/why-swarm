...
import com.lwohvye.gateway.security.security.filter.CustomAuthenticationFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public FilterInvocationSecurityMetadataSource customFilterInvocationSecurityMetadataSource() {
        return new CustomFilterInvocationSecurityMetadataSource(resourceFeignClientService);
    }
